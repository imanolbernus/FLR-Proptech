...
from app.api.v1.endpoints import auth, contratos, documentos, inquilinos, pagos, propiedades, tickets, usuarios
...
protected_router.include_router(documentos.router)
